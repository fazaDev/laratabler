    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown {{ request()->is(['aplikasi', 'pengguna']) ? 'active' : '' }}">
                    ...
                    <div class="dropdown-menu {{ request()->is(['aplikasi', 'pengguna']) ? 'show' : '' }}">
                        <a class="dropdown-item {{ request()->is('aplikasi') ? 'active' : '' }}" href="#">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <a class="dropdown-item {{ request()->is('pengguna') ? 'active' : '' }}" href="#">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
